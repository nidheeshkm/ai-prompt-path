...
import { BookOpen, Clock, Trophy, ChevronRight, ArrowLeft, Award, Layers, Key, AlertTriangle } from 'lucide-react'
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-slate-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Curriculum */}
        <div>
          <h2 className="text-lg font-bold text-slate-900 mb-3">Curriculum</h2>
          <div className="space-y-2">
            {course.chapters.map((chapter) => (
              <div key={chapter.id} className="glass rounded-xl p-4 flex items-center gap-3">
                <span className="text-xl shrink-0">{chapter.icon}</span>
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-emerald-600 font-semibold">{chapter.part}</p>
